		...
		<div class="row">
			<div class="register span6">
				<form action="pict/regist.action" method="post">
					...
					<div class="form-group has-feedback">
						<label class="pwdsureLabel">确认密码</label> <input AUTOCOMPLETE="off"
					...
					<div class="form-group has-feedback">
						<label class="checkLabel">验证码</label> <input type="text"
							...
							id="checkCode" placeholder="验证码" maxlength="4">
					...
					<div class="form-group has-feedback">
						<input type="submit" class="btn btn-success" value='立即注册' /> <br>
